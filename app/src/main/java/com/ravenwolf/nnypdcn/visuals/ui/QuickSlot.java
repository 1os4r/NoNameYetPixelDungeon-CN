...
public class QuickSlot extends Button implements WndBag.Listener {
    ...
    //private static final String TXT_SELECT_ITEM_OFFHAND = "Select a missile or a throwing weapon";
...
/*
    ...
    private static final int EQUIPPED	= 0xFF4A4D44;
    protected static final int SLOT_BG_WIDTH	= 16;//18;
    protected static final int SLOT_BG_HEIGTH	= 18//20;
...
//		lastItem = null;
	...
	protected void createChildren() {
       /* bg = new ColorBlock( SLOT_BG_WIDTH, SLOT_BG_HEIGTH, EQUIPPED );
        bg.visible =false;
        add( bg );
*/
...
/*
        bg.x = x+1;
        bg.y = y;
        bg.visible =this.power instanceof Item && ((Item) this.power).isEquipped(Dungeon.hero);
*/
	}
...
//		Object content = (this == setAsQuickSlot1 ? quickslotValue_1 : quickslotValue_2);
        ...
        if( this == quickslot0 ) {
            ...
            /*power = Dungeon.hero.belongings.ranged;*/

            value = (/*Dungeon.hero.belongings.ranged == null ||*/ Dungeon.hero.belongings.weap1 instanceof RangedWeapon &&
...
//			}
	...
	public void item( Item item ) {
		...
		itemInSlot = item;
//        bg.visible =item!=null && item.isEquipped(Dungeon.hero);
		enableSlot();
	}
