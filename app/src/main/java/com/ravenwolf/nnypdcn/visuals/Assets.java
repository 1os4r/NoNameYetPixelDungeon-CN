 ...
 */
package com.ravenwolf.nnypdcn.visuals;
...
public class Assets {
	...
	public static final String SCHOLAR  = "pc_scholar.png";
	public static final String BRIGAND  = "pc_brigand.png";
	public static final String ACOLYTE  = "pc_acolyte.png";
    ...
    public static final String KEEPER1  = "npc_shop_human.png";
    public static final String KEEPER2  = "npc_shop_ghost.png";
    public static final String KEEPER3  = "npc_shop_troll.png";
    public static final String KEEPER4  = "npc_shop_dwarf.png";
	public static final String KEEPER_DOC  = "npc_shop_plague_doc.png";
