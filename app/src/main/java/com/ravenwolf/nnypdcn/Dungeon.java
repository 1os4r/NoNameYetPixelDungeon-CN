...
import com.ravenwolf.nnypdcn.levels.CavesBossLevel;
...
import com.ravenwolf.nnypdcn.levels.HallsBossLevel;
import com.ravenwolf.nnypdcn.levels.HallsLevel;
import com.ravenwolf.nnypdcn.levels.LastLevel;
...
import com.ravenwolf.nnypdcn.levels.PrisonBossLevel;
...
import com.ravenwolf.nnypdcn.scenes.StartScene;
import com.ravenwolf.nnypdcn.visuals.ui.QuickSlot;
import com.ravenwolf.nnypdcn.visuals.windows.WndResurrect;
...
//		hero.viewDistance = light == null ? bonus.viewDistance : Math.max( Light.DISTANCE, bonus.viewDistance );
	...
	public static boolean wellNeeded() {
		//int[] quota = {1, 0, 3, 1, 5, 2, 11, 4, 17, 6, 23, 8, 29, 10};
		//last level will spawn 3 wells
		int[] quota = {1, 0, 5, 2, 11, 4, 14, 5, 17, 6, 23, 8, 29, 10};
		return chance( quota, wells );
	}
	
	public static boolean souNeeded() {
        //int[] quota = {1, 0, 3, 1, 5, 2, 11, 4, 17, 6, 23, 8, 29, 10};
		//last level will spawn 3 scrolls
		int[] quota = {/*1, 0,*/ 3, 1, 5, 2, 11, 4, 17, 6, 23, 8, 29, 11};
...
//    }
    ...
    public static boolean wandsNeeded() {
       // int[] quota = {1, 0, 5, 1, 11, 2, 17, 3, 23, 4, 29, 5};
		//Prison guaranted wand is quest one, so removed one
		int[] quota = {1, 0, 5, 1, 11, 1, 17, 2, 23, 3, 29, 4};
